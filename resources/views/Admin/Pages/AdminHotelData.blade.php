                    ...
                    <div class="card card-body">
                        <div class="row">
                            ...
                            <div class="col-12 mt-2">
                                <form action="{{ route('Create.table',$hotelData->hotel_id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="input-group flex-nowrap mb-3">
                                        <span class="input-group-text" id="addon-wrapping">Table Name</span>
                                    ...
                                    <div class="input-group flex-nowrap mb-3">
                                        <span class="input-group-text" id="addon-wrapping">Table Seats</span>
                                    ...
                                    <button type="submit" class="btn btn-primary rounded-0 px-3">Add Table </button>
                                </form>
                            </div>
                        </div>
                    </div>
