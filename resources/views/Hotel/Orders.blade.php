        ...
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="text-center mt-5">Wating Payment To Catcher </h1>
                        </div>
                    </div>
                    <div class="row" style="overflow-y: scroll">
                        <div class="col-12">
                            <table class="table table-hover table-bordered mt-5">
                                ...
                                <tbody>
                                    ...
                                    {{-- @dd($orders) --}}
                                    @foreach ($paidToCatcherOrders as $order)
                                        <tr>
                                            <th scope="row">{{ $order->order_id }}</th>
                                            <td>{{ $order->created_at->format('H:i:s') }}</td>
                                            <td>{{ $order->table->table_name }}</td>
                                            ...
                                            <td>
                                                @if (isset($order->transaction) && isset($order->transaction->invoice_id))
                                                    {{ $order->transaction->invoice_id }}
                                                @else
                                                    No Invoice
                                                @endif
                                            ...
                                            <td>
                                                @if (isset($order->user) && isset($order->user->name))
                                                    {{ $order->user->name }}
                                                @endif
                                            </td>
                                            @can('process_payment')
