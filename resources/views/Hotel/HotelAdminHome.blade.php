                                    ...
                                    <tbody class="table-group-divider ">
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="text-center"><a href="#"
                                                    class="text-primary text-decoration-none">{{$transaction->order->user->nic}}</a></td>
                                            <td class="text-center">{{ $transaction->order->orderdMenus()->count() }}</td>
                                            <td class="text-center">Rs.{{ number_format($transaction->total_price, 2) }}</td>
